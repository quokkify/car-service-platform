...
| [latest/pyramid-snapshot.md](./latest/pyramid-snapshot.md) | **Auto-generated latest accepted `main` snapshot** from merged Allure results (refreshed by scheduled/manual **Test Pyramid Snapshot Refresh** via rolling PR; do not hand-edit). |
